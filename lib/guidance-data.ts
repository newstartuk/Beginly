...
export const GUIDANCE_PAGES: GuidanceArticle[] = [
  {
    ...
    disclaimer:
      "Beginly provides general settlement guidance. This does not constitute legal, immigration, financial, tax, medical, or housing advice. For official matters, consult qualified professionals or official government sources.",
  ...
  },
  {
    ...
    disclaimer:
      "Beginly provides general settlement guidance. This is not a substitute for official travel, immigration, or safety guidance.",
    lastReviewed: "May 2026",
  ...
  },
  {
    ...
    disclaimer:
      "Beginly provides scam awareness guidance. This is not legal or financial advice. If you have been the victim of fraud, contact Action Fraud and your bank immediately.",
    lastReviewed: "May 2026",
  ...
  },
  {
    ...
    disclaimer:
      "Beginly provides general health signposting. This is not medical advice. For medical concerns, contact the NHS or your GP.",
    lastReviewed: "May 2026",
  ...
  },
  {
    ...
    disclaimer:
      "Beginly provides general health signposting. This is not medical advice. Always seek professional medical help for health concerns.",
    lastReviewed: "May 2026",
  ...
  },
  {
    ...
    disclaimer:
      "Beginly provides general information about council tax. This is not legal or tax advice.",
    lastReviewed: "May 2026",
  ...
  },
  {
    ...
    disclaimer:
      "Beginly provides general administrative guidance. Check with your university for their specific student status letter process.",
    lastReviewed: "May 2026",
  ...
  },
  {
    ...
    disclaimer:
      "Beginly provides general guidance. Compare all providers and read terms before purchasing any SIM or eSIM plan.",
    lastReviewed: "May 2026",
  ...
  },
  {
    ...
    disclaimer:
      "Beginly provides general transport guidance. Discount eligibility and prices change — check official provider websites for current information.",
    lastReviewed: "May 2026",
  ...
  },
  {
    ...
    disclaimer:
      "Beginly provides general financial guidance. This is not financial advice. Seek professional advice for significant financial decisions.",
    lastReviewed: "May 2026",
  ...
  },
  {
    ...
    disclaimer:
      "Beginly provides general information about deposit protection. For legal advice, contact Shelter or a qualified solicitor.",
    lastReviewed: "May 2026",
  ...
  },
  {
    ...
    disclaimer:
      "Beginly provides general guidance on working as a student. This is not legal or immigration advice.",
    lastReviewed: "May 2026",
  ...
  },
  {
    ...
    disclaimer:
      "Beginly provides general guidance on National Insurance. For tax advice, contact HMRC or a qualified accountant.",
    lastReviewed: "May 2026",
  ...
  },
  {
    ...
    disclaimer:
      "Beginly provides general guidance on right-to-work. For immigration advice, consult a qualified immigration solicitor.",
    lastReviewed: "May 2026",
  ...
  },
  {
    ...
    disclaimer:
      "Beginly provides general guidance on job scams. This is not legal advice. If you have been a victim of fraud, contact Action Fraud and your bank immediately.",
    lastReviewed: "May 2026",
  ...
  },
  {
    ...
    disclaimer:
      "Beginly provides general emergency contact information. Always use official emergency services for genuine emergencies.",
    lastReviewed: "May 2026",
  ...
  },
  {
    ...
    whatToPrepare: [
      "Your Beginly checklist progress",
      "Notes from your first weeks",
      "A blank document or notebook",
    ],
    stepsToTake: [
      "Open your Beginly checklist — how many of your 90-day tasks are complete?",
    ...
    safetyWarning: undefined,
    sourceSignpost:
      "Beginly guidance library: guides | Your university student support | Citizens Advice: citizensadvice.org.uk",
    disclaimer:
      "Beginly provides general settlement guidance. This is not professional advice. Seek support from qualified professionals for health, legal, immigration, or financial concerns.",
    lastReviewed: "May 2026",
