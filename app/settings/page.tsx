    ...
    async function loadSession() {
      if (isClientDemoMode()) {
        ...
        setUser({
          ...
          email: storedUser?.email ?? "demo@beginly.app",
          profile_completed: true,
        });
        if (storedProfile) {
          setProfile({
            arrival_type: storedProfile.arrivalType,
            status: storedProfile.arrivalStatus,
            arrival_date: storedProfile.arrivalDate,
            city: storedProfile.city,
            university: storedProfile.university,
            accommodation: storedProfile.accommodationType,
            nationality: storedProfile.nationality,
            english_level: storedProfile.englishLevel,
            work_interest: storedProfile.interestedInWork,
          });
        }
      ...
      <div className="max-w-2xl mx-auto space-y-5 animate-fade-in">
        ...
        <div className="card border-red-200">
          ...
          <p className="text-sm text-civic-600 mb-4">
            This deletes your Beginly app data in this browser/session and from the Beginly database tables. Your Supabase Auth login may still exist until account deletion is handled by an admin/service-role flow.
          </p>
          {!confirmDelete ? (
