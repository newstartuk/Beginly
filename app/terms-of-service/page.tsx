        ...
        <div className="prose prose-sm max-w-none space-y-8">
          ...
          <section>
            ...
            <ul className="mt-2 space-y-1.5 text-sm text-muted list-disc pl-5">
              ...
              <li>An automated chatbot (Nia) that provides general orientation information and explains documents.</li>
          ...
          {/* Section 4 */}
          <section>
            <h2 className="text-lg font-bold text-navy mb-3">4. Nia — acceptable use</h2>
            <p className="text-sm text-muted leading-relaxed">
              Nia is an automated orientation assistant built into the Beginly platform. When you
              use Nia, you agree:
            </p>
            <ul className="mt-2 space-y-1.5 text-sm text-muted list-disc pl-5">
              ...
              <li>That Nia&apos;s responses are generated automatically and may not always be accurate or complete.</li>
          ...
          <section>
            ...
            <p className="text-sm text-muted leading-relaxed">
              All content on Beginly — including text, design, logos, software, and
              Nia — is owned by Beginly or its licensors and is protected by applicable
