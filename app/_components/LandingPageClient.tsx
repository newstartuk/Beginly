  ...
  return (
    <div className="min-h-screen" style={{ background: "var(--color-white)" }}>
          ...
          <div className="mt-12 grid grid-cols-3 gap-4 max-w-lg mx-auto">
            {[
              ...
              <div key={s.label} className="text-center">
                <p className="text-2xl font-extrabold" style={{ color: "var(--color-teal)" }}>
                  {s.value}
                </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8 items-stretch">
            ...
            >
              ...
              <h2 className="text-xl font-bold mb-4" style={{ color: "var(--color-navy)" }}>
      ...
      <section className="py-20 px-6" style={{ background: "var(--color-mist)" }}>
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-xs font-bold uppercase tracking-widest mb-3" style={{ color: "var(--color-teal)" }}>
              What you get
            </p>
            <h2 className="text-2xl sm:text-3xl font-bold" style={{ color: "var(--color-navy)" }}>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            {TRUST_BADGES.map((b) => (
              ...
              >
                <div className="w-10 h-10 rounded-xl flex items-center justify-center mx-auto mb-3" style={{ background: "var(--color-teal-50)" }}>
      ...
      <section className="pb-20 px-6">
        <div className="max-w-3xl mx-auto">
          <div className="rounded-3xl p-10 sm:p-14 text-center relative overflow-hidden bg-[#102A43]">
            <div
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm mb-8 max-w-xl mx-auto leading-relaxed" style={{ color: "rgba(255,255,255,0.75)" }}>
      ...
      <footer className="border-t py-8 px-6" style={{ borderColor: "var(--color-border)" }}>
        <div className="max-w-6xl mx-auto space-y-5">
          ...
          <div className="flex flex-wrap gap-5 justify-center">
            ...
            <Link href="/privacy-policy" className="text-xs hover:text-teal" style={{ color: "var(--color-muted)" }}>Privacy Policy</Link>
            <Link href="/terms-of-service" className="text-xs hover:text-teal" style={{ color: "var(--color-muted)" }}>Terms of Service</Link>
